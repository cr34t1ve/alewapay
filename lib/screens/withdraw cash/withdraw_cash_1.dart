...
class WithdrawCash1 extends StatefulWidget {
  const WithdrawCash1({Key? key}) : super(key: key);

  @override
  _WithdrawCash1State createState() => _WithdrawCash1State();
}

class _WithdrawCash1State extends State<WithdrawCash1> {
  var text = '';
